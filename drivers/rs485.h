...
/*接收缓冲*/
static char rs485_rx_buffer[64];
#define DELAY_RS485_POLL    5
//模式控制
#define PA1_RS485_TX_EN		GPIO_SetBits(GPIOD,GPIO_Pin_4)	//485模式控制.0,接收;1,发送.
#define PA1_RS485_RX_EN		GPIO_ResetBits(GPIOD,GPIO_Pin_4)
